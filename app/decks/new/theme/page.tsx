...
export default function ModeBStub() {
  return (
    <main className="flex-1 flex flex-col">
      ...
      <section className="flex-1 flex items-center justify-center px-8 py-20">
        <div className="text-center max-w-lg">
          ...
          <h1 className="font-display text-4xl text-ink mb-4">Mode thème</h1>
          <p className="font-body text-ink/60 mb-8">
            Cette page sera disponible dans la prochaine itération. On y entre
            un thème ou un archétype, et on propose des commanders pertinents.
          </p>
